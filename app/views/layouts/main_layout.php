			...
			<div id="main-content">
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-footer">
								...
								<a href="" id="delete-record-modal-btn" class="btn btn-primary">Hapus</a> 
							</div>
						</div>
					</div>
				</div>
				...
				<template id="page-loading-indicator">
					<div class="p-2 text-center m-2 text-muted m-auto">
						...
						<h4 class="p-3 mt-2 font-weight-light">Tunggu...</h4>
					</div>
				</template>
				<template id="page-saving-indicator">
					<div class="p-2 text-center m-2 text-muted">
						<div class="lds-dual-ring"></div>
						<h4 class="p-3 mt-2 font-weight-light">Proses...</h4>
					</div>
				</template>
