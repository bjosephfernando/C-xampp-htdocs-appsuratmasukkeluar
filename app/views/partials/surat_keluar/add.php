                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-Tujuan_surat"  value="<?php  echo $this->set_field_value('Tujuan_surat',""); ?>" type="text" placeholder="Masukkan tujuan surat"  required="" name="Tujuan_surat"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
