                ...
                <div class="col-sm-6 comp-grid">
                    <div class="">
                        <div class="text-center">
                           Belum punya akun? <a class="btn btn-primary" href="<?php print_link('') ?>">Masuk</a>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <label class="control-label" for="photo">Foto<span class="text-danger">*</span></label>
                                                        </div>
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <div class="dropzone required" input="#ctrl-photo" fieldname="photo"    data-multiple="false" dropmsg="Unggah foto" btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
