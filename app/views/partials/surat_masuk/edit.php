                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-Nomor_Surat"  value="<?php  echo $data['Nomor_Surat']; ?>" type="text" placeholder="Masukkan nomor surat"  required="" name="Nomor_Surat"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-Asal_surat"  value="<?php  echo $data['Asal_surat']; ?>" type="text" placeholder="Masukkan pengirim surat"  required="" name="Asal_surat"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <textarea placeholder="Masukkan keterangan" id="ctrl-perihal"  required="" rows="5" name="perihal" class=" form-control"><?php  echo $data['perihal']; ?></textarea>
