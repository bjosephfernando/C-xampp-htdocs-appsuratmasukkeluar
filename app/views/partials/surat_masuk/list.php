                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-Asal_surat"> Pengirim</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <th class="td-btn">
                                                        <a class="btn btn-sm btn-success has-tooltip" title="Lihat data" href="<?php print_link("surat_masuk/view/$rec_id"); ?>">
                                                            <i class="fa fa-eye"></i> Lihat
                                                        </a>
                                                        <a class="btn btn-sm btn-info has-tooltip" title="Edit data" href="<?php print_link("surat_masuk/edit/$rec_id"); ?>">
                                                            <i class="fa fa-edit"></i> Edit
                                                        </a>
                                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="Hapus data" href="<?php print_link("surat_masuk/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Yakin akan menghapus data?" data-display-style="modal">
                                        ...
                                        <div class="row justify-content-center">    
                                            <div class="col-md-auto justify-content-center">    
                                                <div class="p-3 d-flex justify-content-between">    
                                                    <button data-prompt-msg="Yakin akan menghapus data?" data-display-style="modal" data-url="<?php print_link("surat_masuk/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
